...
echo "\nChecking specifically for year 2030:\n";
$payments2030 = Payment::where('payment_year', 2030)->get();

echo "Found {$payments2030->count()} payments for 2030:\n";
foreach ($payments2030 as $payment) {
